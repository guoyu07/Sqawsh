...
/**
 * Runs the acceptance tests using the (headless) HtmlUnit browser.
 * 
...
@CucumberOptions(
    plugin = {"pretty", "html:cucumberhtmlunitreport"},
...
//@formatter:on
public class RunHtmlUnitAcceptanceTests {
  ...
  public static void setupSquashWebsiteUrl() {
    ...
    p.setProperty("WebDriverType", "HtmlUnit");
